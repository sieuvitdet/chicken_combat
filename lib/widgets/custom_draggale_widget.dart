...
class _DraggableWidgetState extends State<DraggableWidget> {
    ...
    try {
      ...
      setState(() {
        ...
        _maxOffset = Offset(
            ...
            parentSize.height-size.height - MediaQuery.of(context).padding.top
        );
      });
    } catch (e) {
      debugPrint('catch: $e');
  ...
  void _updatePosition(PointerMoveEvent pointerMoveEvent) {
    ...
    if (newOffsetX < _minOffset.dx + 20) {
      newOffsetX = _minOffset.dx + 20;
    } else if (newOffsetX > _maxOffset.dx - 60) {
      newOffsetX = _maxOffset.dx - 60;
    }

    if (newOffsetY < _minOffset.dy + 100) {
      newOffsetY = _minOffset.dy + 100;
