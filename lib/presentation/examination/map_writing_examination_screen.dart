...
class Pagination {
  int? stt;
  String? anwser;
  Pagination({this.stt, this.anwser});
}

class MapWritingExaminationScreen extends StatefulWidget {
  const MapWritingExaminationScreen({super.key});

  @override
  State<MapWritingExaminationScreen> createState() =>
      _MapWritingExaminationScreenState();
}

class _MapWritingExaminationScreenState
    extends State<MapWritingExaminationScreen> with WidgetsBindingObserver {
  // String text = "";
  String text1 =
